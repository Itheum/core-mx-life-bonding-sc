...
use multiversx_sc_scenario::{
    ...
    scenario_model::{
        AddressValue, CheckAccount, CheckStateStep, ExternalStepsStep, ScQueryStep, SetStateStep,
        TransferStep, TxExpect,
    },
    DebugApi,
};

use crate::bonding_state::bonding_state::{
    ContractState, ANOTHER_TOKEN_IDENTIFIER, ANOTHER_TOKEN_IDENTIFIER_EXPR,
    BONDING_CONTRACT_ADDRESS_EXPR, DATA_NFT_IDENTIFIER, DATA_NFT_IDENTIFIER_EXPR,
...
fn bond() {
    ...
    state
        ...
        .check_state_step(CheckStateStep::new().put_account(
            FIRST_USER_ADDRESS_EXPR,
            CheckAccount::new().esdt_balance(ITHEUM_TOKEN_IDENTIFIER_EXPR, "900"),
        ));
